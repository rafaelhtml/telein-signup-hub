  ...
  useEffect(() => {
    ...
    const dispararEventos = () => {
      ...
      if (pixelId && pixelId !== '1701412423354782') {
        ...
        // Aguarda um pouco após inicializar
        setTimeout(() => {
          dispararEventosCustomizados(conversionName);
        }, 300);
      } else {
        dispararEventosCustomizados(conversionName);
      }
    ...
    const dispararEventosCustomizados = (conversionName: string | null) => {
